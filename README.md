Bank System in C++ 🚀
    A robust, console-based Banking System application developed in modern C++. This project demonstrates strong software engineering principles,
    utilizing Object-Oriented Programming (OOP) and File Handling to manage secure user accounts, transactions, and persistent data storage.

Key Features & Architecture 🛠️
  Object-Oriented Programming (OOP):

      Implements an abstract base class Account with derived classes CurrentAccount and SavingAccount to handle account-specific rules,
      withdrawal fees, and investment balances using polymorphism.
  ...
  Security & Authentication:
      ...
      Robust input validation for National IDs (14 digits) and strict password policies 
...
│   └── SavingAccount.cpp
│
├── FileHandling/          # Contains persistent data text files (git-ignored for security)
│   ├── account.txt
│   └── Transactions.txt
│
...
Compile all source files together with the header include paths using a C++ compiler (like g++):
